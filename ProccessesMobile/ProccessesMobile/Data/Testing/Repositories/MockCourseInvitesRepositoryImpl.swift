...
public struct MockCourseInvitesRepositoryImpl: CourseInvitesRepository {
    private let client: HTTPClient
    private let baseURL: URL
    
    public init(client: HTTPClient, baseURL: URL) { self.client = client; self.baseURL = baseURL }
    
    public func listInvites(courseId: String) async throws -> [Invite] {
    ...
    public func createInvite(courseId: String, request: CreateInviteRequest) async throws -> Invite {
    ...
    public func revokeInvite(courseId: String, inviteId: String) async throws {
