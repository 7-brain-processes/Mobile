...
struct MockDownloadSolutionFileUseCase: DownloadSolutionFileUseCase {
    let repo: SolutionFilesRepository
    func execute(courseId: String, postId: String, solutionId: String, fileId: String) async throws -> Data {
