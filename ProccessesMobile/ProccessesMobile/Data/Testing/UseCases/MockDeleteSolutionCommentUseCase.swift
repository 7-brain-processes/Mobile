...
public struct MockDeleteSolutionCommentUseCase: DeleteSolutionCommentUseCase {
    let repo: SolutionCommentsRepository
    public func execute(courseId: String, postId: String, solutionId: String, commentId: String) async throws {
