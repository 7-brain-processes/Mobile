...
final class DefaultCourseCategoriesRepository: CourseCategoriesRepository, Sendable {
    ...
    func createCourseCategory(
        ...
        let endpoint = CourseCategoriesEndpoint.create(courseId: courseId, request: requestDTO)
        let (data, response) = try await apiClient.send(endpoint)
    ...
    func updateCourseCategory(
        ...
        let requestDTO = UpdateCourseCategoryRequestMapper.toDTO(request)
        let endpoint = CourseCategoriesEndpoint.update(
            courseId: courseId,
    ...
    func deleteCourseCategory(
        ...
        let endpoint = CourseCategoriesEndpoint.delete(
            courseId: courseId,
            categoryId: categoryId
        )
